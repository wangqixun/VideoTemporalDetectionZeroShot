...
data_root = '/new_share/caojinglong/video_classify/dataset/kinetics400/train/video'
data_root_val = '/new_share/caojinglong/video_classify/dataset/kinetics400/val/video'
...
# resume_from='/new_share/wangqixun/workspace/githup_project/Video-Swin-Transformer/work_dirs/v1_6/latest.pth'
resume_from=None
