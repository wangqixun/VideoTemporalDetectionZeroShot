...
data_root = '/new_share/caojinglong/video_classify/dataset/kinetics400/train/frames'
data_root_val = '/new_share/caojinglong/video_classify/dataset/kinetics400/val/frames'
ann_file_train = 'data/kinetics400/k400_train_frame.txt'
ann_file_val = 'data/kinetics400/k400_val_frame.txt'
ann_file_test = 'data/kinetics400/k400_val_frame.txt'
img_norm_cfg = dict(
