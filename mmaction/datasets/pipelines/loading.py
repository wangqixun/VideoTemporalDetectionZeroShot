...
class RawFrameDecode:
    ...
    def __call__(self, results):
        ...
        filename_tmpl = results['filename_tmpl']  # '{:05d}.jpg'
...
@PIPELINES.register_module()
class LoadLocalizationFeatureZeroShot:
    """Load Video features for localizer with given video_name list.
    ...
    def __call__(self, results):
        """Perform the LoadLocalizationFeatureZeroShot loading.
...
@PIPELINES.register_module()
class GenerateLocalizationLabelsZeroShot:
    """Load video label for localizer with given video_name list.
    ...
    def __call__(self, results):
        """Perform the GenerateLocalizationLabelsZeroShot loading.
        ...
        # mask_need = (gt_bbox[:, 1]-gt_bbox[:, 0]) > self.temporal_gap
